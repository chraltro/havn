...
| Any LLM agent | `CLAUDE.md` | Works as generic agent instructions |
...
**Example: ask an LLM to add a new data source**

> "Add a new ingest script that loads CSV files from data/ into the landing schema,
> then create bronze/silver/gold transforms to clean and aggregate the data."
