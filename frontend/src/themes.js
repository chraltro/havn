...
export const COLOR_THEMES = {
  "havn-dark": {
    ...
    vars: {
      "--havn-bg": "#0C1014",
      "--havn-bg-secondary": "#111A1E",
      "--havn-bg-tertiary": "#090D10",
      "--havn-border": "#1A2B2E",
      "--havn-border-light": "#243B3E",
      "--havn-text": "#D2DCD8",
      "--havn-text-secondary": "#6A8580",
      "--havn-text-dim": "#384E4A",
      "--havn-accent": "#3ECFB4",
      "--havn-green": "#34D399",
  ...
  "midnight-terminal": {
    ...
    vars: {
      "--havn-bg": "#050805",
      "--havn-bg-secondary": "#0C120C",
      "--havn-bg-tertiary": "#030503",
      "--havn-border": "#152015",
      "--havn-border-light": "#1E2E1E",
      "--havn-text": "#B8CCBA",
      "--havn-text-secondary": "#5A7A5E",
      "--havn-text-dim": "#2E4830",
      "--havn-accent": "#6ee7b7",
      "--havn-green": "#34d399",
  ...
  "electric": {
    ...
    vars: {
      "--havn-bg": "#0E0E16",
      "--havn-bg-secondary": "#16161F",
      "--havn-bg-tertiary": "#0A0A12",
      "--havn-border": "#232338",
      "--havn-border-light": "#2E2E48",
      "--havn-text": "#E2E2EE",
      "--havn-text-secondary": "#6E6E90",
      "--havn-text-dim": "#40405A",
      "--havn-accent": "#818cf8",
      "--havn-green": "#4ade80",
  ...
  "corporate": {
    name: "Corporate",
    description: "Clean professional theme with cool blue undertone",
    dark: false,
    vars: {
      "--havn-bg": "#F4F5F8",
      "--havn-bg-secondary": "#E9EBF0",
      "--havn-bg-tertiary": "#FEFEFF",
      "--havn-border": "#D2D5DE",
      "--havn-border-light": "#BFC3CE",
      "--havn-text": "#2C3040",
      "--havn-text-secondary": "#6A7088",
      "--havn-text-dim": "#9CA0B0",
      "--havn-accent": "#4a7cbc",
      "--havn-green": "#5a9a5a",
