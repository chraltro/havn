...
const st = {
  ...
  modeBtn: { padding: "4px 12px", background: "none", border: "none", borderRadius: "var(--dp-radius)", color: "var(--dp-text-secondary)", cursor: "pointer", fontSize: "12px", fontWeight: 500 },
  modeActive: { padding: "4px 12px", background: "var(--dp-btn-bg)", border: "none", borderRadius: "var(--dp-radius)", color: "var(--dp-text)", cursor: "pointer", fontSize: "12px", fontWeight: 600 },
  ...
  btn: { padding: "6px 16px", background: "var(--dp-btn-bg)", border: "1px solid var(--dp-btn-border)", borderRadius: "var(--dp-radius-lg)", color: "var(--dp-text)", cursor: "pointer", fontSize: "12px", fontWeight: 500 },
  btnPrimary: { padding: "6px 16px", background: "var(--dp-green)", border: "1px solid var(--dp-green-border)", borderRadius: "var(--dp-radius-lg)", color: "#fff", cursor: "pointer", fontSize: "12px", fontWeight: 500 },
