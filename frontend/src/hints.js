 ...
 *   target      - CSS selector for positioning (data-havn-hint attribute)
...
export const HINTS = [
  {
    ...
    target: "[data-havn-hint='run-summary']",
    priority: 5,
  ...
  },
  {
    ...
    action: null,
    target: "[data-havn-hint='query-sidebar']",
    priority: 7,
  ...
  },
  {
    ...
    action: null,
    target: "[data-havn-hint='connector-list']",
    priority: 6,
  ...
  },
  {
    ...
    target: "[data-havn-hint='connector-health']",
    priority: 3,
    repeatable: true,
  ...
  {
    id: "git-detected",
    text: "havn detected a git repo. Try `havn status` in your terminal or check the Diff tab to see data changes across branches.",
    action: { label: "Open Diff", navigate: "Diff" },
    target: "[data-havn-hint='git-status']",
    priority: 9,
    condition: (s) => !!s.gitDetected,
  },
  {
    id: "uncommitted-changes",
    text: "You have uncommitted changes. Run `havn checkpoint` to commit with an auto-generated message.",
    action: null,
    target: "[data-havn-hint='git-status']",
    priority: 4,
  ...
  },
  {
    ...
    action: null,
    target: "[data-havn-hint='diff-results']",
    priority: 8,
  ...
  },
  {
    ...
    action: null,
    target: "[data-havn-hint='dag-canvas']",
    priority: 10,
  ...
  },
  {
    ...
    action: null,
    target: "[data-havn-hint='columns-bar']",
    priority: 9,
  ...
  },
  {
    ...
    target: "[data-havn-hint='pipeline-health']",
    priority: 6,
