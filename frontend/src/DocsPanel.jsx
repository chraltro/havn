...
const styles = {
  ...
  loading: { color: "#8b949e", textAlign: "center", padding: "24px" },
  empty: { color: "#484f58", textAlign: "center", padding: "24px" },
};

const mdStyles = {
  h1: { fontSize: "24px", fontWeight: 700, margin: "24px 0 12px", borderBottom: "1px solid #21262d", paddingBottom: "8px" },
  h2: { fontSize: "20px", fontWeight: 600, margin: "20px 0 10px", borderBottom: "1px solid #21262d", paddingBottom: "6px" },
  ...
  table: { width: "100%", borderCollapse: "collapse", margin: "8px 0", fontSize: "12px", fontFamily: "monospace" },
  th: { textAlign: "left", padding: "6px 12px", borderBottom: "1px solid #30363d", color: "#8b949e", fontWeight: 600 },
