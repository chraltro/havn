...
export const DASHBOARD_CHART_TYPES = [
  // Basic
  { id: "bar", label: "Bar", group: "Basic", desc: "Vertical bars comparing categories" },
  { id: "line", label: "Line", group: "Basic", desc: "Trends over time or continuous data" },
  { id: "area", label: "Area", group: "Basic", desc: "Like line, with filled area below" },
  { id: "scatter", label: "Scatter", group: "Basic", desc: "Plot two numeric values as points" },
  { id: "pie", label: "Pie", group: "Basic", desc: "Show proportions of a whole" },
